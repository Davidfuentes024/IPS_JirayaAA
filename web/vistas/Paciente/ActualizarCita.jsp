                        ...
                        <form class="form-horizontal" action="srvUsuario?accion=actualizarCita" method="post">
                            ...
                            <div class="box-body">
                                <div class="form-group" style="">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <select id="elfamoso" class="form-control" name="sede" required disabled>
                                            <option value="0">Seleccione una sede</option>
                                            <c:forEach items="${sedes}" var="sed">
                                                <option value="${sed.codigo}" <c:if test="${sed.codigo eq citN.sede.codigo}">selected</c:if>>${sed.nombreSede}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <select class="form-control" name="consultorio" required disabled>
                                            <option value="0">Seleccione un consultorio</option>
                                            <c:forEach items="${consultorios}" var="con">
                                                <option value="${con.codigo}" <c:if test="${con.codigo eq citN.consultorio.codigo}">selected</c:if>>${con.nombreConsultorio}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <input id="dateInput" class="form-control" type="date" name="fecha" min="<%= LocalDate.now()%>" >
                                </div>
                            </div>                               
