...
public class srvUsuario extends HttpServlet {
    ...
    private void verificar(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (usuario != null && usuario.getCargo().getNombreCargo().equals("ADMINISTRADOR")) {
            ...
            this.getServletConfig().getServletContext().getRequestDispatcher("/vistas/formPaciente.jsp").forward(request, response);
        } else {
    ...
    private void crearCita(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            this.getServletConfig().getServletContext()
                    .getRequestDispatcher("/vistas/nuevaCita.jsp").forward(request, response);
        } catch (Exception e) {
